<template>
    <div style="min-height: min-content; display: flex; font-family: Roboto;">
        ...
        <div style="flex: auto; display: flex; flex-direction: column; min-height: min-content; padding-left: 50px; padding-right: 50px; padding-top: 40px">
            ...
            <div style="background: rgba(0, 0, 0, 0.7); box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.14); border-radius: 15px; padding: 20px; margin-bottom: 15px; display: flex">
                <div style="flex: auto">
            ...
            <div style="background: #DDEDEE; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.14); border-radius: 15px; padding: 20px; margin-bottom: 10px; display: flex; font-family: Quicksand;">
                <div style="flex: auto">
